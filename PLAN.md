...
**DoD**
- [ ] 결과 카드가 ui.md S4 요소를 전부 포함 — **텍스트 중심 상용화 개편(2026-07-19)**: `overview`를 "이곳의 매력"로, `detailIntro2` 유형별 이용시간·휴무·체험·요금·주차·메뉴 등을 정규화해 값이 있는 최대 4행 방문정보로 표시. 배지·상태 아이콘·색상 칩 제거, 상세 시트는 전체 정규화 원문 표시. type12·14·28·38·39 매핑과 빈 값 보충·최대 4행을 유닛테스트로 고정. 브라우저 시각 확인은 **사람 체크리스트**
