...
**DoD**
- [x] 8방위 메시지가 스핀 정지 연출에 표시 — 루트 앱의 별이 화면 흐름 기준으로 유지. 콜드 스타트 하단의 2겹 파란 물결이 대기 중 찰랑이고 완료 시 화면을 채우는 1회 모션과 모션 최소화 페이드를 추가. `npm run check`·`npm run build`·guard 통과(2026-07-31)
