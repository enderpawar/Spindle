...
| 1.0.8 | 2026-09-07 | `cf49159` | (아래 참조) | 1.0.7 + **롱프레스 이미지 브래킷 제거**(`0a0b960`). `main` 머지 후 첫 빌드 — 이 시점부터 웹 프로덕션도 같은 코드다 |
...
| 항목 | 결과 |
|---|---|
| 최신 TestFlight 버전 | **1.0.8** (커밋 `cf49159`) — 1.0.7은 롱프레스 브래킷으로 폐기 |
