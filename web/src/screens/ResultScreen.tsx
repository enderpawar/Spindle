        ...
        {loading ? (
          ...
          <div key={poi.id} className="motion-card-enter">
            ...
            <div style={{ padding: '18px 2px 0' }}>
              ...
              <div aria-hidden style={{ height: 1, background: 'var(--l-line)', margin: '16px 0' }} />

              <div className="result-info-facts result-info-facts--preview">
              ...
              {/* 이 방향으로 코스 짜기 — 단일 추천을 이어 갈 2~4곳 코스로 확장 (docs/course.md) */}
              <button
                type="button"
                onClick={buildCourse}
                className="btn"
                style={{ width: '100%', height: 54, marginTop: 20, background: 'var(--l-primary)', border: 'none', color: '#fff', fontSize: 15 }}
              >
                이 방향으로 코스 짜기
              </button>
              {courseNotice && (
