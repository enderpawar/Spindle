...
| 홈 | 스핀 | 결과 카드 | 코스 안내 |
|---|---|---|---|
| <img src="docs/screenshots/a01-home.png" width="200" alt="홈 — 스핀 시작·바로가기·테마 덱·추천 여행지"> | <img src="docs/screenshots/a02-spin.png" width="200" alt="스핀 — 8방위 나침반 원판과 이동시간 다이얼"> | <img src="docs/screenshots/a04-result.png" width="200" alt="결과 카드 — TourAPI 사진·소개·방문정보"> | <img src="docs/screenshots/a08-course-guide.png" width="200" alt="코스 안내 — 카카오맵 위 순번 핀과 1단계 안내 카드"> |
...
2. **스핀** 탭 → 상단 `부산역 기준` 확인 (부산 밖이면 여행 모드가 기본)
3. 이동시간 다이얼을 **60분** 정도로 조절
4. 원판을 손가락으로 **휙 밀어서** 돌리기 (휴대폰을 흔들어도 된다) → 방위 확정 연출 → 결과 카드
5. 결과 카드에서 사진·소개·이용시간·휴무·길찾기 확인 → `공유 카드 만들기`
6. 뒤로 → 결과 카드의 **`이 방향으로 코스 짜기`** → **2~4곳 코스 지도**
